...
public class Inicio extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(imagenOriginal, javax.swing.GroupLayout.DEFAULT_SIZE, 563, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(reiniciar)
                            .addComponent(guardar)
                            .addComponent(imagenModificada, javax.swing.GroupLayout.DEFAULT_SIZE, 563, Short.MAX_VALUE))
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(imagenOriginal, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE)
                            .addComponent(imagenModificada, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(aver)))
                    .addComponent(Avergin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(gaus)
    ...
    private void BrilloStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_BrilloStateChanged
       ...
       //System.out.print("AnteriorL" + anteriorL + " Level" + level + " Accion" + accion + " Tono" + tono + "\n");
    ...
    private void NegativeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_NegativeItemStateChanged
       ...
       reiniciar.setEnabled(true);
        ...
        if(Negative.isSelected()){
            byte[] buffer = img.toBytes(negativeImage);
            
            negativeImage = Filters.Negative(buffer, negativeImage);
            Image image = img.toImage(negativeImage,buffer);
            imagenModificada.setIcon(new ImageIcon(image.getScaledInstance(this.imagenModificada.getWidth(), this.imagenModificada.getHeight(), Image.SCALE_DEFAULT)));
    ...
    private void BinarizarItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_BinarizarItemStateChanged
       ...
       reiniciar.setEnabled(true);
        if(Binarizar.isSelected()){
            buffer = img.toBytes(binarizarImagen);
            binarizarImagen = Filters.Binarizacion(buffer, binarizarImagen);
            Image image = img.toImage(binarizarImagen,buffer);
            imagenModificada.setIcon(new ImageIcon(image.getScaledInstance(this.imagenModificada.getWidth(), this.imagenModificada.getHeight(), Image.SCALE_DEFAULT)));
        }else if(!Binarizar.isSelected()){
            buffer = img.toBytes(myImage);
            Image image2 = img.toImage(myImage,buffer);
    ...
    private void ContrasteStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_ContrasteStateChanged
       ...
       reiniciar.setEnabled(true);
        ...
        level = (int) source.getValue();
        buffer =img.toBytes(contrastImage);
        ...
        contrastImage = Filters.Contrast(buffer, contrastImage, accion2);
        Image image = img.toImage(contrastImage, buffer);
        imagenModificada.setIcon(new ImageIcon(image.getScaledInstance(this.imagenModificada.getWidth(), this.imagenModificada.getHeight(), Image.SCALE_DEFAULT)));
    ...
    private void GammaStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_GammaStateChanged
        ...
        if(anteriorL>level){
            ...
            gammaImage = Filters.Gamma(buffer, gammaImage,level);
            image = img.toImage(gammaImage, buffer);
            imagenModificada.setIcon(new ImageIcon(image.getScaledInstance(this.imagenModificada.getWidth(), this.imagenModificada.getHeight(), Image.SCALE_DEFAULT)));
            anteriorL=level;
        }
    ...
    private void AverginStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_AverginStateChanged
        ...
        suavImage = Filters.smoothing(suavImage, 1);
        Image imageToShow;
        
        buffer = img.toBytes(suavImage);       
        
        imageToShow = img.toImage(suavImage, buffer);
    ...
    private void GaussianStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_GaussianStateChanged
        ...
        suavImage = Filters.smoothing(suavImage, 2);
        Image imageToShow;
    ...
    private void MedianStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_MedianStateChanged
        ...
        suavImage = Filters.smoothing(suavImage, 3);
        Image imageToShow;
